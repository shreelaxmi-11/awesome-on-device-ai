...
Every product decision was mine: which templates to build, why TF-IDF over a vector DB, two-pass LLM for meeting summarization, the MLX vs LiteRT-LM benchmark methodology. The real performance numbers (44.62 tok/s vs 2.81 tok/s) came from actual experiments on my M3 Pro.
